...
RANDT = 100     #factor de aleatoriedad en el tamaño de las ramas (%)
...
ANGHOJA = 90    #ángulo de las puntas de las hojas (180 = círculos)
PROF = 12        #cantidad de niveles en el árbol (más de 10 puede durar mucho dibujándose)

CTRONCO = (165,42,42)  #color del tronco. tres números entre 0 y 255
CTRONCOVAR = 15         #factor de aleatoriedad en el color del tronco
CHOJAS =  (100,200,30)  #color de las hojas
CHOJASVAR = 40         #factor de aleatoriedad en el color de las hojas
